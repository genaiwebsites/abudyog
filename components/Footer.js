      ...
      <div className="footer-grid">
        <div>
          ...
          <div className="footer-social">
            ...
            <a href="https://in.linkedin.com/company/ab-udyog-pvt-ltd" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="LinkedIn" title="AB Udyog on LinkedIn">
              <svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
            ...
            <a href="https://www.youtube.com/channel/UCzz1eldG3F66AHrFLkUXSFQ" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="YouTube" title="AB Udyog YouTube Channel">
              <svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
