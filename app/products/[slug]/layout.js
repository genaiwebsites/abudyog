...
const PRODUCT_META_MAP = {
  ...
  'rice-bran-wax': {
    title: 'Refined Rice Bran Wax (76°C MP)',
  ...
  'spent-bleaching-earth': {
    title: 'Eco-Friendly Spent Bleaching Earth',
...
export async function generateMetadata({ params }) {
  ...
  const product = PRODUCT_META_MAP[slug] || {
    title: 'Industrial Products & Derivatives',
